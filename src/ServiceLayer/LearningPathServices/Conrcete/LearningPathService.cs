...
public class LearningPathService : ILearningPathService
{
    ...
    public StepNavigationVm StartLearningPath(int learningPathId)
    {
        ...
        return _navigationService.GetStepNavigationVm(learningPath, firstStep);
    }
    ...
    public StepNavigationVm? MarkStepAsCompletedAndProceed(int learningPathId, int currentStepId)
    {
        ...
        return _navigationService.GetStepNavigationVm(learningPath, nextStep);
    }
    ...
    public StepNavigationVm? GetStepToContinue(int learningPathId)
    {
        ...
        var continueStep = _navigationService.FindContinueStepInPath(learningPath);
        if (continueStep == null)
        {
            return null;
        }

        return _navigationService.GetStepNavigationVm(learningPath, continueStep);
    }
    ...
    public StepNavigationVm GetStepNavigationViewModel(int learningPathId, int stepId)
    {
